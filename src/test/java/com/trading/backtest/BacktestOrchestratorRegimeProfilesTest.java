...
import com.trading.backtest.BacktestOrchestrator.RegimeProfile;
 ...
 */
@DisplayName("BacktestOrchestrator — 레짐 프로필 리스트")
class BacktestOrchestratorRegimeProfilesTest {

    @Test
    @DisplayName("regime-sens 프로필은 [OFF, MA96, MA120, MA144] — MA120 ±20% 단일 파라미터 스윕")
    void regimeSensProfilesAreMa120PlusMinus20() {
        assertThat(BacktestOrchestrator.REGIME_SENS_PROFILES).hasSize(4);

        RegimeProfile s0 = BacktestOrchestrator.REGIME_SENS_PROFILES.get(0);
        RegimeProfile s1 = BacktestOrchestrator.REGIME_SENS_PROFILES.get(1);
        RegimeProfile s2 = BacktestOrchestrator.REGIME_SENS_PROFILES.get(2);
        RegimeProfile s3 = BacktestOrchestrator.REGIME_SENS_PROFILES.get(3);
    ...
    void regimeLabProfilesUnchanged() {
        assertThat(BacktestOrchestrator.REGIME_PROFILES).hasSize(3);

        RegimeProfile g0 = BacktestOrchestrator.REGIME_PROFILES.get(0);
        RegimeProfile g1 = BacktestOrchestrator.REGIME_PROFILES.get(1);
        RegimeProfile g2 = BacktestOrchestrator.REGIME_PROFILES.get(2);
